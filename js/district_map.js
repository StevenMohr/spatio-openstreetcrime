...
var DistrictMap, GeoReceiver, HistoricMapData, HistoryMap, HistoryReceiver, MapControls, MapData, MapStyle, ReportReceiver, StatTable, berlin_center, epsg4326, epsg900913, server_url,
  _this = this;
...
DistrictMap = {
  ...
  initialize: function() {
    ...
    this.map.setCenter(berlin_center, 10);
...
MapData = {
  ...
  quantils: function() {
    var nr_reports, reports, _, _ref;
    if (this.quantil_list.length === 0) {
      nr_reports = 0;
      _ref = ReportReceiver.crime_stat;
      for (_ in _ref) {
        reports = _ref[_];
        nr_reports += reports;
      }
      nr_reports = nr_reports / 12;
      this.quantil_list = [nr_reports * 0.75, nr_reports * 1, nr_reports * 1.25];
    }
    return this.quantil_list;
  }
};
