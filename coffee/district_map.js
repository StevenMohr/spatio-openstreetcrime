...
(function() {
  ...
  DistrictMap = {
    ...
    add_district_layer: function() {
      ...
      this.map.addLayer(this.district_layer);
      return get_location();
    }
  };
  ...
  MapData = {
    ...
    district_features: function() {
      var district, features, geojson_parser, in_options, relevant_count, style, wkt_polygon, _i, _len, _ref;
      relevant_count = (this.weighted ? 'weighted_count' : 'count');
      in_options = {
        internalProjection: new OpenLayers.Projection('EPSG:3785'),
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        wkt_polygon = geojson_parser.read(district['area']);
